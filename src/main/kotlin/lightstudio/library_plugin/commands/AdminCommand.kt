...
class AdminCommand(private val plugin: Library_plugin) : CommandExecutor, TabCompleter {
    ...
    override fun onTabComplete(sender: CommandSender, command: Command, label: String, args: Array<out String>): MutableList<String>? {
        if (args.size == 1) {
            return mutableListOf("reload", "setreward", "givebookreward").filter { it.startsWith(args[0], true) }.toMutableList()
        }
        return null
    }
}
